...
<html lang="en">
	...
	<body class="ltr main-body leftmenu error-1">
							...
							<div class="col-lg-6 col-xl-5 d-none d-lg-block text-center bg-primary details">
								<div class="mt-5 pt-4 p-2 pos-absolute">
									...
									<a href="{{ route('homepage') }}">
										<img src="../assets/img/brand/icon-light.png" class="ht-100 mb-0" alt="UNitCAre">
									</a>
								...
								<div class="main-container container-fluid">
									<div class="row row-sm">
										<div class="card-body mt-2 mb-2">
											<a href="{{ route('homepage') }}">
												<img src="../assets/img/brand/logo.png" class="header-brand-img text-start float-start mb-4" alt="UNitCAre">
											</a>
											<div class="clearfix"></div>
											<form method="POST" action="{{ route('login.post') }}">
												...
												<div class="form-group text-start">
													<label>Email</label>
													<input class="form-control @error('email') is-invalid @enderror" placeholder="Enter your email" type="email" name="email" value="{{ old('email') }}" required autofocus>
												</div>
												<div class="form-group text-start">
		...
		@if(session('success'))
		<script>
		Swal.fire({ toast: true, position: 'top-end', icon: 'success', title: "{{ session('success') }}", showConfirmButton: false, timer: 4000, timerProgressBar: true, confirmButtonColor: '#6259ca' });
		</script>
		@endif
