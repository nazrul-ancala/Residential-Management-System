...
<head>
    ...
    <!-- Title -->
    <title> @yield('page_title', 'UNitCAre')</title>
                    ...
                    <div class="container px-sm-0">
                        <div class="row">
                            ...
                            <div class="col-xl-6 col-lg-6 my-auto">
                                <img src="../assets/landing/images/market3.png" alt="">
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="container">
                            <div class="row">
                                ...
                                <div class="row mt-7">
                                    ...
                                    <div class="col-lg-3 col-md-12">
                                        <div class="card features main-features main-features-5 wow fadeInUp reveal revealleft"
                                            data-wow-delay="0.1s">
                                            <div class="card-body">
                                                <div class="counter-body-2">
                                                    <div class="bg-img mb-2 text-left hexagon-wrapper">
                                    ...
                                    <div class="col-lg-3 col-md-12">
                                        <div class="card features main-features main-features-7 wow fadeInUp reveal revealleft"
                                            data-wow-delay="0.1s">
                                            <div class="card-body">
                                                <div class="counter-body-2">
                                                    <div class="bg-img mb-2 text-left hexagon-wrapper">
                                    ...
                                    <div class="col-lg-3 col-md-12">
                                        <div class="card features main-features main-features-8 wow fadeInUp reveal revealleft"
                                            data-wow-delay="0.1s">
                                            <div class="card-body">
                                                <div class="counter-body-2">
                                                    <div class="bg-img mb-2 text-left hexagon-wrapper">
                                                                                ...
                                                                                <div class="bg-transparent">
                                                                                    <div class="counter-status">
                                                                                        ...
                                                                                        <div
                                                                                            ...
                                                                                            <h1 class=" mb-0">
                                                                                                <span
                                                                                                    class="counter fw-semibold counter">100</span>
                                                                                                <span class="">+</span>
                                                                                            </h1>
                                                                                            <div class="counter-text">
                                                                                                <h5
                                            ...
                                            <div class="col-xl-4 col-lg-6 col-md-6 col-sm-12 myorder-1">
                                                <div class="working-svg-container svg-container-2">
                                                    <svg xmlns="http://www.w3.org/2000/svg" id="Layer_1" x="0" y="0"
                                                        enable-background="new 0 0 300 300" version="1.1"
                                        ...
                                        <div class="row align-items-center">
                                            <div class="col-xl-4 col-lg-6 col-md-6 col-sm-12">
                                                <div class="working-svg-container svg-container-3">
                                                    <svg xmlns="http://www.w3.org/2000/svg" id="Layer_1" x="0" y="0"
                                                        enable-background="new 0 0 750 700" version="1.1"
                                                        viewBox="0 0 750 700" xml:space="preserve">
                                                        <g id="_x37_">
                                                            <path fill="#98b1e6"
...
C431.3,1830.2,378.4,1777.3,378.4,1712z" />
                                ...
                                <section class="sptb demo-screen-demo" id="faqs">
                                    <div class="row align-items-center">
                                        ...
                                        <div class="col-md-12 col-lg-6 reveal revealright">
                                            <img src="../assets/landing/images/frequently-asked-questions.png" alt="">
                                        </div>
                                    </div>
                                </section>
                            </div>
                                                ...
                                                <div class="col-xl-12">
                                                    <div class="">
                                                        <form class="reveal">
                                                            ...
                                                            <div class="form-group">
                                                                <label for="cusSubject"
                                                                    class="form-label">Subject</label>
                                                                <input type="text" class="form-control" id="cusSubject"
    ...
    <script src="../assets/landing/lib/company-slider/slider.js"></script>
    ...
    <!-- SIDE-MENU JS -->
    <script src="../assets/landing/js/sidemenu.js"></script>
